...
require_contains ".config/quickshell/ControlCenter.qml" 'implicitHeight: detailPage === "" \? 720 : 860' "quick panel grows downward for more working room"
require_contains ".config/quickshell/ControlCenter.qml" 'Layout\.preferredHeight: 120' "quick panel has compact status tile grid"
require_contains ".config/quickshell/ControlCenter.qml" 'Layout\.preferredHeight: 56' "quick panel has compact status tiles"
require_contains ".config/quickshell/ControlCenter.qml" 'Layout\.preferredHeight: controlCenter\.detailPage === "" \? 390 : 550' "quick panel gives extra space to notification and detail views"
require_contains ".config/quickshell/ControlCenter.qml" 'Layout\.preferredHeight: 34' "quick panel has compact footer actions"
require_contains ".config/quickshell/ControlCenter.qml" 'property bool doNotDisturb: false' "control center tracks do not disturb state"
require_contains ".config/quickshell/ControlCenter.qml" 'function toggleDoNotDisturb\(' "control center can toggle do not disturb"
require_contains ".config/quickshell/ControlCenter.qml" 'shownInPopup: !controlCenter\.doNotDisturb' "do not disturb blocks notification popups without dropping notifications"
